...
const PART_NUMBERS = {
  ...
  PNEUMATIC_VALVE_75KW_WITH_ANTIFREEZE: TODO_PN(
    "PNEUMATIC_VALVE_75KW_WITH_ANTIFREEZE",
  ), // TODO Add real PN and add to Excel
  PNEUMATIC_VALVE_75KW_NO_ANTIFREEZE: TODO_PN(
    "PNEUMATIC_VALVE_75KW_NO_ANTIFREEZE",
  ), // TODO Add real PN and add to Excel
  TWO_PNEUMATIC_VALVES_75KW_WITH_ANTIFREEZE: TODO_PN(
    "TWO_PNEUMATIC_VALVES_75KW_WITH_ANTIFREEZE",
  ), // TODO Add real PN and add to Excel
  TWO_PNEUMATIC_VALVES_75KW_NO_ANTIFREEZE: TODO_PN(
  ...
  LOW_BARS_75KW: TODO_PN("LOW_BARS_75KW"), // TODO add real PN and add to Excel
