...
export const ActivityActionLabels: Record<ActivityAction, string> = {
  ...
  OFFER_REVISION_DISCARD: "Scarto revisione offerta",
  ...
  OFFER_REVISION_UNACCEPT: "Annullamento accettazione revisione offerta",
  OFFER_REVISION_DECLINE: "Rifiuto revisione offerta",
  OFFER_REVISION_EXPIRE: "Scadenza revisione offerta",
  CONFIG_AS_SOLD_UNFREEZE: "Scongelamento configurazione come venduta",
